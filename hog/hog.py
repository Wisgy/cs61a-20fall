...
def final_strategy(score, opponent_score):
    ...
    If the current player will take another turn by rolling 0 dice, he will give priority to it.Otherwise,
    he will take different strategy based on the current score difference.
