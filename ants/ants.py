...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            assert (isinstance(place.ant, ContainerAnt) and place.ant.can_contain(self)) or \
                   (isinstance(self, ContainerAnt) and self.can_contain(place.ant)), 'Two ants in {0}'.format(place)
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while current_place != beehive:
            if len(current_place.bees) != 0 and distance >= self.min_range and distance <= self.max_range:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        for bee in bees:
            bee.reduce_armor(amount + self.damage if self.armor - amount <= 0 else amount)
...
# END Problem EC
    ...
    def __init__(self, armor=1):
        ...
        self.buff_ant = []
        if QueenAnt.True_QueenAnt == None:
            QueenAnt.True_QueenAnt = self
        # END Problem EC
    ...
    def action(self, gamestate):
        ...
        # BEGIN Problem EC
        "*** YOUR CODE HERE ***"
        if QueenAnt.True_QueenAnt == self:
            current_place = self.place.exit
            while current_place != None:
                if current_place.ant != None and current_place.ant not in self.buff_ant:
                    current_place.ant.damage *= 2
                    self.buff_ant.append(current_place.ant)
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem EC
        "*** YOUR CODE HERE ***"
        if amount and self == QueenAnt.True_QueenAnt:
            bees_win()
        else:
    ...
    def remove_from(self, place):
        if self != QueenAnt.True_QueenAnt:
...
class Bee(Insect):
    ...
    def action(self, gamestate):
        ...
        # BEGIN EC
        "*** YOUR CODE HERE ***"
        destination = self.place.entrance if self.neg_dire else destination
        # END EC
        if self.blocked():
...
class ScaryThrower(ThrowerAnt):
    ...
    def throw_at(self, target):
        # BEGIN Problem Optional 4
        "*** YOUR CODE HERE ***"
        if target and target.scared != True:
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self, beehive):
        ...
        while current_place != beehive:
            ...
            if current_place.ant != None and current_place.ant != self:
                insect_dict[current_place.ant] = distance
            distance += 1
            current_place = current_place.entrance
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 5
        damage = self.damage - 0.05 * self.insects_shot - 0.2 * distance
        if damage < 0:
            damage = 0
        return damage
        # END Problem Optional 5
